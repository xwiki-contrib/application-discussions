...
/**
 * A programmatic right for Read discussion feature.
 *
 * @version $Id$
 * @since 1.0
 */
public final class ReadDiscussionRight implements RightDescription
{
    /**
     * Singleton instance for a read discussion right.
     */
    public static final ReadDiscussionRight INSTANCE = new ReadDiscussionRight();

    private ReadDiscussionRight()
    {
    }
