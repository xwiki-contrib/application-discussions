...
/**
 * Represents the reference of a {@link org.xwiki.contrib.discussions.domain.Discussion}.
 *
 ...
 */
@Unstable
public class DiscussionReference extends AbstractDiscussionReference
{
    /**
     * Default constructor.
     *
     ...
     */
    public DiscussionReference(String applicationHint, String reference)
    {
